// event_emitter: a small thread-safe pub/sub utility for arbitrary event
// payload types
#pragma once
...
// Back-compat: keep the old qualified name net::udp::event_emitter as an alias
namespace net
{
  namespace udp
  {
    template <typename EventT>
    using event_emitter = ::utils::event_emitter<EventT>;
  } // namespace udp
} // namespace net
